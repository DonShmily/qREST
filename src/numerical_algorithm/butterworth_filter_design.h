...
#ifndef SRC_NUMERICAL_ALGORITHM_BUTTERWORTH_FILTER_DESIGN_H_
#define SRC_NUMERICAL_ALGORITHM_BUTTERWORTH_FILTER_DESIGN_H_
...
#endif // SRC_NUMERICAL_ALGORITHM_BUTTERWORTH_FILTER_DESIGN_H_